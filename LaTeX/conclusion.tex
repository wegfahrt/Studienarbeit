...
\textbf{Adressierung der Informationsasymmetrie:} Das implementierte Quest-Management-System mit Kanban-Board und Flow-Chart-Visualisierung adressiert das Problem der mangelnden Übersicht vollständig. Die quantitative Evaluation weist eine Erfüllungsquote von 96,2\% für alle zugehörigen Akzeptanzkriterien aus, während die qualitative Evaluation mit einem Problemlösungs-Score von 4,42/5 die wahrgenommene Effektivität bestätigt. Insbesondere das Kanban-Board (4,75/5) und die Flow-Chart-Visualisierung (4,50/5) wurden von den Nutzern als besonders hilfreich bewertet.

\textbf{Verbesserung des Ressourcenmanagements:} Der Material-Calculator und der Workstation-Planner ermöglichen die in Abschnitt~\ref{sec:problemstellung} geforderte Kalkulation benötigter Materialien und Priorisierung von Upgrades. Mit einer Erfüllungsquote von 100\% und einem UX-Score von 4,33/5 wurde dieses Ziel erreicht. Der während der Entwicklung ergänzte Recycling-Kalkulator (UX-Score 4,42/5) demonstriert den Mehrwert kontinuierlicher Stakeholder-Einbindung und erweitert die Ressourcenplanungsfähigkeiten um eine im ursprünglichen Scope nicht vorgesehene Dimension.
...
\textbf{Eingeschränkte Stichprobengröße:} Die qualitative Evaluation mit vier Teilnehmern limitiert die statistische Aussagekraft der \ac{SUS}-Ergebnisse. Die beobachtete Varianz von 30 Punkten zwischen den Teilnehmern unterstreicht die Notwendigkeit größerer Stichproben für eine verlässliche Bewertung.
...
Die vorliegende Arbeit demonstriert die systematische Entwicklung einer Companion App für einen Extraction Shooter unter Anwendung moderner Web-Technologien und etablierter Software-Engineering-Praktiken. Die erreichte Erfüllungsquote von 96,23\% bei den Akzeptanzkriterien und der \ac{SUS}-Score von 73,75 (\glqq Good\grqq{}) validieren die gewählten Architektur- und Technologieentscheidungen.
