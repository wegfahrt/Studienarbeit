...
\subsection{Die Client-Server State Dichotomie}
...
queryClient.invalidateQueries({
  predicate: (query) => query.queryKey[0] === 'quests' && query.state.data?.status === 'active'
})
\end{lstlisting}
