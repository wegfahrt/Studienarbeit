...
\begin{lstlisting}[caption={Performance-Messung in Cypress}, label={lst:cypress-performance}]
cy.get('[data-testid="quest-search"]')
  .then(() => { startTime = performance.now(); })
  .type(searchTerm);

cy.get('[data-testid="quest-card"]')
...
AC-QM-01.2 & E2E (Cypress) & $\checkmark$ / $\times$ & Gemessen: --ms \\
... & ... & ... & ... \\
\bottomrule
\end{tabular}
\end{table}
