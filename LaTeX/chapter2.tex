...
Die qualitative Bewertungsskala ist in Tabelle~\ref{tab:bewertungsskala} definiert.

\begin{table}[htbp]
\centering
\caption{Qualitative Bewertungsskala für MCDA}
\label{tab:bewertungsskala}
\begin{tabular}{clp{7cm}}
\toprule
\textbf{Wert} & \textbf{Symbol} & \textbf{Bedeutung} \\
\midrule
5 & \texttt{++} & Exzellent – übertrifft Anforderungen deutlich \\
4 & \texttt{+} & Gut – erfüllt Anforderungen vollständig \\
3 & \texttt{o} & Ausreichend – erfüllt Mindestanforderungen \\
2 & \texttt{-} & Mangelhaft – erfüllt Anforderungen nur teilweise \\
1 & \texttt{-{}-} & Ungenügend – erfüllt Anforderungen nicht \\
\bottomrule
\end{tabular}
\end{table}
