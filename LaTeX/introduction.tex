...
\begin{itemize}
  \item \textbf{4.1.1 Performance-Metriken:} Messung von Page Load Time durch Metriken wie der \ac{TTI} für alle Hauptseiten. Messung der API-Antwortzeiten für kritische Endpunkte sowie Überwachung der Server- und Datenbank-Performance (CPU-, Speicher- und Datenbank-Latenz) unter Lastbedingungen.
